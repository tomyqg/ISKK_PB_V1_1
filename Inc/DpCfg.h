...
*/
#define USER_WD                     ((uint16_t)0x0AFF)   // User Watchdog
...
/*!
   ...
   - 0 to 244
*/
#define DIN_BUFSIZE                 ((uint8_t)0xF0)//02    // Length of the DIn Buffer (Data Slave to Master)                0..244
...
/*!
   ...
   - 0 to 244
*/
#define DOUT_BUFSIZE                ((uint8_t)0xF0)//02    // Length of the DOut Buffer     (Data Master to Slave)           0..244
...
/*!
   ...
   - 6 to 244
*/
#define DIAG_BUFSIZE                ((uint8_t)0x20)//6     // Length of the Diagnosis Buffer                                 6..244
...
/*!
   ...
   - 1 to 244
*/
#define CFG_BUFSIZE                 ((uint8_t)0xF0)//01    // Length of the Configuration Buffer                             1..244
...
*/
#define SSA_BUFSIZE                 ((uint8_t)0xAA)     // Length of the Input Data in the Set_Slave_Address-Buffer 0 and 4..244
...
/*-----------------------------------------------------------------------*/
/* ModeRegister2 (7..0) ( page 23 )   (only VPC3+B, VPC3+C)              */
/*-----------------------------------------------------------------------*/
//
//  bit  7          6          5        4       3          2          1            0
//  --------------------------------------------------------------------------------------
...
/*-----------------------------------------------------------------------*/
/* ModeRegister3 (7..0) ( page 25 )   (VPC3+C)                           */
/*-----------------------------------------------------------------------*/
//
//  bit  7          6          5          4          3         2       1         0
//  -----------------------------------------------------------------------------------
...
/*-----------------------------------------------------------------------*/
/* Interrupt Mask Register (7..0) ( page 29 )                            */
/*-----------------------------------------------------------------------*/
//  bit7       6          5           4             3             2          1         0
//  ----------------------------------------------------------------------------------------
...
/*-----------------------------------------------------------------------*/
/* Interrupt Mask Register (15..8) ( page 31 )                           */
/*-----------------------------------------------------------------------*/
