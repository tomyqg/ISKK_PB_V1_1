   ...
   if( DpAppl_TestApplEvent( eDpApplEv_IoOut ) )
   {
      ...
      if( pToOutputBuffer )
      {
         CopyFromVpc3_( &sDpAppl.abDpOutputData[0], pToOutputBuffer, pDpSystem->bOutputDataLength );
			...
			if(Main_ISKK.ISKK_Interface.Profibus_Pool==false){
				HAL_GPIO_WritePin(INT_in_GPIO_Port,INT_in_Pin,GPIO_PIN_RESET);
				Main_ISKK.ISKK_Interface.Profibus_Pool=true;
				UART1.TRANSMIT_BUFFOR_TAB[0]=k_Frame_2Byte;
				UART1.TRANSMIT_BUFFOR_TAB[1]=0xFF;
				UART1.TRANSMIT_BUFFOR_TAB[2]=kControl;
				UART1.TRANSMIT_BUFFOR_TAB[3]=0x11;//PlytkaWersja
				UART1.TRANSMIT_BUFFOR_TAB[4]=0x00;//Nr Seryjny
				HAL_UART_Transmit(&huart1,UART1.TRANSMIT_BUFFOR_TAB,5,100);
				HAL_GPIO_WritePin(INT_in_GPIO_Port,INT_in_Pin,GPIO_PIN_SET);
			}
			...
			if(SSK_To_ISKK.Control!=sDpAppl.abDpOutputData[0]){
				...
				UART1.TRANSMIT_BUFFOR_TAB[1]=0xFF;
				UART1.TRANSMIT_BUFFOR_TAB[2]=kControl;
				UART1.TRANSMIT_BUFFOR_TAB[3]=sDpAppl.abDpOutputData[0];
				UART1.TRANSMIT_BUFFOR_TAB[4]=sDpAppl.abDpOutputData[0];
				HAL_UART_Transmit(&huart1,UART1.TRANSMIT_BUFFOR_TAB,5,100);
				HAL_GPIO_WritePin(INT_in_GPIO_Port,INT_in_Pin,GPIO_PIN_SET);
			}
			...
			if(sProfibus_Prm.Alfa!=sProfibus_Prm.SSK_Alfa){
				...
				UART1.TRANSMIT_BUFFOR_TAB[4]=sProfibus_Prm.Alfa;
				HAL_UART_Transmit(&huart1,UART1.TRANSMIT_BUFFOR_TAB,5,100);
				HAL_GPIO_WritePin(INT_in_GPIO_Port,INT_in_Pin,GPIO_PIN_SET);
			}
			...
			if(sProfibus_Prm.fuse_Iznam!=sProfibus_Prm.fuse_Iznam){
				...
				UART1.TRANSMIT_BUFFOR_TAB[4]=sProfibus_Prm.fuse_Iznam;
				HAL_UART_Transmit(&huart1,UART1.TRANSMIT_BUFFOR_TAB,5,100);
				HAL_GPIO_WritePin(INT_in_GPIO_Port,INT_in_Pin,GPIO_PIN_SET);
			}
			if(sProfibus_Prm.fuse_Imax!=sProfibus_Prm.fuse_Imax){
				...
				UART1.TRANSMIT_BUFFOR_TAB[4]=sProfibus_Prm.fuse_Imax;
				HAL_UART_Transmit(&huart1,UART1.TRANSMIT_BUFFOR_TAB,5,100);
				HAL_GPIO_WritePin(INT_in_GPIO_Port,INT_in_Pin,GPIO_PIN_SET);
			}
			if(sProfibus_Prm.fuse_Iroz!=sProfibus_Prm.fuse_Iroz){
				...
				UART1.TRANSMIT_BUFFOR_TAB[4]=sProfibus_Prm.fuse_Iroz;
				HAL_UART_Transmit(&huart1,UART1.TRANSMIT_BUFFOR_TAB,5,100);
				HAL_GPIO_WritePin(INT_in_GPIO_Port,INT_in_Pin,GPIO_PIN_SET);
			}
